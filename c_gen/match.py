...
#OFDPA_FIXUP start
    ...
    ofdpa_traffic_class = dict(
        name="ofdpa_traffic_class",
        m_type="uint8_t",
        print_type="PRIx8",
        conditions="",
        takes_mask_in_spec=False,
    ...
    ofdpa_qos_index = dict(
        name="ofdpa_qos_index",
        m_type="uint8_t",
        print_type="PRIx8",
        conditions="",
        takes_mask_in_spec=False,
    ...
    ofdpa_mpls_l2_port = dict(
        name="ofdpa_mpls_l2_port",
        m_type="uint32_t",
        print_type="PRIx32",
        conditions="",
        takes_mask_in_spec=True,
    ...
    ofdpa_l3_in_port = dict(
        name="ofdpa_l3_in_port",
        m_type="uint32_t",
        print_type="PRIx32",
        conditions="",
        takes_mask_in_spec=False,
    ...
    ofdpa_mpls_data_first_nibble = dict(
        name="ofdpa_mpls_data_first_nibble",
        m_type="uint8_t",
        print_type="PRIx8",
        conditions="",
        takes_mask_in_spec=False,
    ...
    ofdpa_mpls_ach_channel = dict(
        name="ofdpa_mpls_ach_channel",
        m_type="uint16_t",
        print_type="PRIx16",
        conditions="",
        takes_mask_in_spec=False,
    ...
    ofdpa_mpls_next_label_is_gal = dict(
        name="ofdpa_mpls_next_label_is_gal",
        m_type="uint8_t",
        print_type="PRIx8",
        conditions="",
        takes_mask_in_spec=False,
    ...
    ofdpa_oam_y1731_mdl = dict(
        name="ofdpa_oam_y1731_mdl",
        m_type="uint8_t",
        print_type="PRIx8",
        conditions="",
        takes_mask_in_spec=False,
    ...
    ofdpa_oam_y1731_opcode = dict(
        name="ofdpa_oam_y1731_opcode",
        m_type="uint8_t",
        print_type="PRIx8",
        conditions="",
        takes_mask_in_spec=False,
    ...
    ofdpa_color_actions_index = dict(
        name="ofdpa_color_actions_index",
        m_type="uint32_t",
        print_type="PRIx32",
         conditions="",
        takes_mask_in_spec=False,
    ...
    ofdpa_rx_timestamp = dict(
        name="ofdpa_rx_timestamp",
        m_type="uint64_t",
        print_type="PRIx64",
        conditions="",
        takes_mask_in_spec=False,
    ...
    ofdpa_protection_index = dict(
        name="ofdpa_protection_index",
        m_type="uint8_t",
        print_type="PRIx8",
        conditions="",
        takes_mask_in_spec=False,
    ...
    ofdpa_allow_vlan_translation = dict(
        name="ofdpa_allow_vlan_translation",
        m_type="uint8_t",
        print_type="PRIx8",
        conditions="",
        takes_mask_in_spec=False,
    ...
    ofdpa_mpls_type = dict(
        name="ofdpa_mpls_type",
        m_type="uint16_t",
        print_type="PRIx16",
        conditions="",
        takes_mask_in_spec=False,
...
#OFDPA_FIXUP end
    ...
    onf_actset_output = dict(
        name="onf_actset_output",
        m_type="uint32_t",
        print_type="PRIx32",
        conditions="",
        takes_mask_in_spec=False,
