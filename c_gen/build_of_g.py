    ...
    for version, protocol in loxi_globals.ir.items():
        ...
        for ofclass in protocol.classes:
            ...
            if parent == 'of_action' and experimenter:
                # OFDPA_FIXUP start
                if not cls.startswith('of_action_ofdpa'):
                # OFDPA_FIXUP end
            ...
            # OFDPA_FIXUP start
            if parent == 'of_meter_band' and experimenter:
                if cls.startswith('of_meter_band_ofdpa') and wire_version >= of_g.VERSION_1_3:
                    val = find_type_value(ofclass, 'subtype')
                    type_maps.extension_meter_band_subtype[wire_version][experimenter][cls] = val
            # OFDPA_FIXUP end
